...
window.LESSON = {
  ...
  explore: {
    ...
    onUpdate: (P, Diagram) => {
      ...
      // Enforce: A.y < D.y < B.y (so E is truly on BD produced)
      if (A.y >= D.y - 20) A.y = D.y - 20;
      if (D.y >= B.y - 20) D.y = B.y - 20;
      if (Math.abs(D.y - B.y) < EPS) D.y = B.y - 20;

      // Intersection of line BD with horizontal through A
      const t = (A.y - B.y) / (D.y - B.y);

      // Ensure "BD produced": need t > 1
      ...
      // AE: full width line through A (viewBox is 0..840)
      ...
      // Hatch polygon updates (if they exist)
  ...
  steps: [
    {
      ...
      focusKeep: ["BC"],
      onSelect: () => {
        Diagram.addTriangleHatch("ABC");
        Diagram.addTriangleHatch("DBC");
      },
      onDeselect: () => {
        Diagram.removeTriangleHatch("ABC");
        Diagram.removeTriangleHatch("DBC");
      }
    },
...

    {
      ...
      statementParts: [
        ...
        { t: "BC", ref: ["BC"] },
        { t: " meeting " },
        { t: "BD", ref: ["BD", "lblB", "lblD"] },
        { t: " produced at " },
        { t: "E", ref: ["ptE", "lblE"] },
        { t: ", and join " },
        { t: "EC", ref: ["EC", "lblE", "lblC"] },
        { t: "." }
      ],
      reason: {
        label: "I.31 + I.Post.1",
        kind: "constr",
        tooltip: "Draw a parallel through a point; join two points by a straight line."
      },
...

    {
      ...
      reason: {
        label: "I.37",
        kind: "prop",
        tooltip: "Triangles on the same base and in the same parallels are equal in area."
      },
      ...
      onSelect: () => {
        Diagram.addTriangleHatch("ABC");
        Diagram.addTriangleHatch("EBC");
      },
      onDeselect: () => {
        Diagram.removeTriangleHatch("ABC");
        Diagram.removeTriangleHatch("EBC");
      }
    },

    {
      ...
      reason: {
        label: "C.N. 1",
        kind: "def",
        tooltip: "Things equal to the same thing are equal to one another."
      },
...

    {
      ...
      reason: {
        label: "C.N. 5 (Contradiction)",
        kind: "prop",
        tooltip: "The whole is greater than the part."
      },
...

    {
      ...
      reason: {
        label: "Reductio / Q.E.D.",
        kind: "thus",
        tooltip: "Since the assumption leads to an impossibility, AD ∥ BC."
      },
